...
async function main() {
    ...
    for (const shift of pagerdutyShifts) {
        ...
        if (moment_1.default() < shouldCreateIssueAfter) {
            console.log(`Not making an issue. The issue for this shift should be created after ${shouldCreateIssueAfter.toISOString()}.`);
            continue;
        }
        const matchingExistingIssues = existingIssues.filter(issue => shift.alternativeAnnotations().some(annotation => { var _a; return (_a = issue.body) === null || _a === void 0 ? void 0 : _a.includes(annotation); }));
